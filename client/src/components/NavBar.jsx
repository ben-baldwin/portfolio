  ...
  return (
    <div className='pt-4 lg:pt-0 h-24 flex flex-col items-center md:flex-row justify-between bg-gradient-to-b from-zinc-950 via-zinc-900 to-zinc-800' id='navBackground'>
      ...
      <div className=' text-cyan-100 font-extrabold uppercase flex gap-12'>
        <a className='text-2xl hover:text-3xl transition-all duration-200 transform hover:scale-110' href='#work'>Work</a>
        <a className='text-2xl hover:text-3xl transition-all duration-200 transform hover:scale-110' href="#">Resume</a>
        <a className='text-2xl hover:text-3xl transition-all duration-200 transform hover:scale-110' href="#contact">contact</a>
      </div>
