        ...
        <section className='max-w-screen-2xl mx-auto flex flex-col'>
          ...
          <div className='flex max-w-screen-lg mx-auto'>
            ...
            <div className='flex flex-col justify-end p-8 bg-white rounded-lg self-end'>
              <h1 className='text-4xl font-bold mb-4'>Hi, I'm Ben and I'm a full stack Web Developer.</h1>
          ...
          {/* Work */}
          <div className='mt-16 bg-white p-6 rounded-lg max-w-screen-lg self-center'>
            <p className='text-3xl font-bold mb-4'>Projects and Skills</p>
